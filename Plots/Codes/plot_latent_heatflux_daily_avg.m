...
foret_est_LE = nanmean(reshape(foret_est.LE(id),48,[]),1)*convCoeff;
foret_ouest_LE = nanmean(reshape(foret_ouest.LE_gap_filled(id),48,[]),1)*convCoeff;
berge_LE = nanmean(reshape(berge.LE_gap_filled(id),48,[]),1)*convCoeff;
reservoir_LE = nanmean(reshape(reservoir.LE_gap_filled(id),48,[]),1)*convCoeff;
...
export_fig('../Plots/LE_daily_avg.png')